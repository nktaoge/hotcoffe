...
public class TestTts {
	public static void main(String args[]) {
		 ...
		 * 
		 * while(intPosition > 0) { strVoiceList =
		 * strVoiceList.substring(intPosition + 7); intPosition =
		 * strVoiceList.indexOf("</voice>");
		 * 
		 * lastVoice = strVoiceList.substring(0,intPosition);
		 * //System.out.println(lastVoice); intPosition = strVoiceList.indexOf("<voice>"); } //
		 */
		...
		System.out.println(ttss.getClass().getClassLoader().getResource("arquivo.txt").getPath());
	}
}
